...
// export const API_BASE_URL = ' http://52.202.219.237:8000/api/v1';
export const API_BASE_URL = 'https://fabservice.vigyapan.club/api/v1';
// export const API_BASE_URL='https://fabservices-order.netsolutionindia.com/api/v1'

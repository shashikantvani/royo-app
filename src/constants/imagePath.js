...
export default {
  ...
  //Fab Service new assests
  icAddFab: require("../assets/images/FabServiceNew/ic_add.png"),
  icBackFab: require("../assets/images/FabServiceNew/ic_back.png"),
  icBannerFab: require("../assets/images/FabServiceNew/ic_banner.png"),
  icCarpenterFab: require("../assets/images/FabServiceNew/ic_carpenter.png"),
  icCartActiveFab: require("../assets/images/FabServiceNew/ic_cart1.png"),
  icCartInActiveFab: require("../assets/images/FabServiceNew/ic_cart2.png"),
  icCartroundFab: require("../assets/images/FabServiceNew/ic_cartround.png"),
  icChatFab: require("../assets/images/FabServiceNew/ic_chat.png"),
  icCrossFab: require("../assets/images/FabServiceNew/ic_cross.png"),
  icCleanFab: require("../assets/images/FabServiceNew/ic_clean.png"),
  icDelFab: require("../assets/images/FabServiceNew/ic_del.png"),
  icEditFab: require("../assets/images/FabServiceNew/ic_edit.png"),
  icHomeInactiveFab: require("../assets/images/FabServiceNew/ic_home1.png"),
  icHomeActiveFab: require("../assets/images/FabServiceNew/ic_home2.png"),
  icLinksFab: require("../assets/images/FabServiceNew/ic_links.png"),
  icLocFab: require("../assets/images/FabServiceNew/ic_loc.png"),
  icLogobigFab: require("../assets/images/FabServiceNew/ic_logobig.png"),
  icSmalllogoFab: require("../assets/images/FabServiceNew/ic_smalllogo.png"),
  icSearchFab: require("../assets/images/FabServiceNew/ic_search.png"),
  icProfileActiveFab: require("../assets/images/FabServiceNew/ic_profie2.png"),
  icProfileInActiveFab: require("../assets/images/FabServiceNew/ic_profile3.png"),
  icLocationFab: require("../assets/images/FabServiceNew/ic_location.png"),
};
